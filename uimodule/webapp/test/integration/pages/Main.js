sap.ui.require([
  ...
  var sViewName = "SCO.BTP.ConsultaMaterial.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "Title of SCO.BTP.ConsultaMaterial"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title SCO.BTP.ConsultaMaterial"
            });
        }
      }
